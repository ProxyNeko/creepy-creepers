...
//TODO Make an Australian creeper mob and change the entity below.
//Leave the code here for now, it is unused but custom so it is fine.
public class AustralianCreeperModel extends EntityModel<GhostlyCreeperEntity> {
