...
public class Config {
    ...
    public static class ServerConfig {
        ...
        ServerConfig(ForgeConfigSpec.Builder builder) {
            ...
            BiomeWhitelist = builder.comment("If biomes are specified here, creepers will spawn in ONLY these biomes. (The blacklist is ignored while this is set!)")
                    .defineList("whitelist", Lists.newArrayList(), o -> o instanceof String);

            BiomeBlacklist = builder.comment("If the whitelist is not used, use this list to specify the biomes that creepers should not spawn in.")
